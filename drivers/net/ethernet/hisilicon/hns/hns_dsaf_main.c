...
int hns_dsaf_get_cfg(struct dsaf_device *dsaf_dev)
{
	...
	if (IS_ERR_OR_NULL(syscon)) {
		/** check whether we are using the old dts,
		* the reg region in the old dts is below:
		* <sub_ctrl, serdes_ctrl, ppe_base, dsaf_base>
		**/
